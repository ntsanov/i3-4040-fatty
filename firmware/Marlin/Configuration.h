...
#define STRING_CONFIG_H_AUTHOR "(Nikolay Tsanov, ramps 1.6Plus config)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 12, 35 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 10, -0.4 }
